...
public class HelloTest {
	...
	private String runKDE = String.format("sudo hadoop jar /usr/local/geowave-0.9.6-hdp2/tools/geowave-tools-0.9.6-hdp2.jar analytic kde --featureType gdeltevent --minLevel 5 --maxLevel 26 --minSplits 32 --maxSplits 32 --coverageName %s --hdfsHostPort %s:8020 --jobSubmissionHostPort %s:8032 --tileSize 1 %s %s", vCoverageKDE, hostname, hostname, vStore, vStoreKDE);
