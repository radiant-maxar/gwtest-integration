...
public class HelloTest {
	...
	public void tearDown() throws Exception {
		CmdUtils.send("geowave config rmstore storeName");
	...
	public void vector_happyPath() {
		...
		TestUtils.assertSuccess(CmdUtils.send("geowave gs setls gdeltevent --styleName styleName_sub"));
	}
...
//		TestUtils.assertSuccess(CmdUtils.send(cacheParis));
		...
		// Add Layers
		TestUtils.assertSuccess(CmdUtils.send(hadoop_home, "geowave gs addlayer storeName"));
		TestUtils.assertSuccess(CmdUtils.send(hadoop_home, "geowave gs addlayer copiedStoreName"));
	}
}
