...
# Get GW scripts
cd /mnt
wget s3.amazonaws.com/geowave/latest/scripts/sandbox/quickstart/geowave-env.sh
wget s3.amazonaws.com/geowave/latest/scripts/emr/quickstart/KDEColorMap.sld
...
# Install Gdal
cd /mnt
wget http://demo.geo-solutions.it/share/github/imageio-ext/releases/1.1.X/1.1.7/native/gdal/linux/gdal192-CentOS5.8-gcc4.1.2-x86_64.tar.gz
